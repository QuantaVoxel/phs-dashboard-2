...
export function PackageDeleteButton({ packageId, packageName, redirectAfterDelete = false }: PackageDeleteButtonProps) {
          ...
          <div className="bg-[#020202] border border-danger/30 w-full max-w-md flex flex-col shadow-2xl animate-in fade-in zoom-in-95 duration-200">
             ...
             <div className="p-6 flex flex-col gap-4">
               <p className="font-mono text-xs text-text-muted leading-relaxed">
                 Are you sure you want to delete <span className="text-text-primary font-bold">{packageName}</span>?
               </p>
               <p className="font-mono text-[10px] text-danger/80 uppercase tracking-widest bg-danger/10 p-3 border border-danger/20">
                 Warning: This action will permanently remove this tier and detach it from all associated properties.
               </p>
             </div>
